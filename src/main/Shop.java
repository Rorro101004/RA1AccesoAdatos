...
//	private Sale[] sales;
	...
	private void readInventory() {
		inventory = shop_dao.getInventory();
	...
	public void updateProduct(Product producto) {
		shop_dao.updateProduct(producto);
	}
...
//		numberSales++;
	...
	public boolean writeInventory() {
		if (shop_dao.writeInventory(inventory)) {
			System.out.println("Inventario satisfactorio");
			return true;
		} else {
			System.out.println("Inventario insatisfactorio");
			return false;
		}
	...
	public void addProduct(Product product) {
		...
		this.shop_dao.addProduct(product);
		numberProducts++;
